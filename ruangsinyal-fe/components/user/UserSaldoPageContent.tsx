        ...
        <div className="relative">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-[11px] font-semibold text-white/78">Siap dipakai untuk semua transaksi RuangSinyal</p>
            </div>
          ...
          <div className="mt-5 flex items-center justify-between border-t border-white/15 pt-3">
            <p className="text-[10px] font-black uppercase tracking-[0.22em] text-cyan-100">RuangSinyal Wallet</p>
