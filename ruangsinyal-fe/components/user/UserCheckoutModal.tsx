...
function buildGuestIdentity(dest: string) {
  ...
  return {
    guestNama: "Guest RuangSinyal",
    guestEmail: phone ? `guest-${phone}@ruangsinyal.local` : "guest@ruangsinyal.local",
    guestPhone: phone,
  };
}
...
export function UserCheckoutModal({
  ...
  function handleDownloadProof() {
    void (async () => {
      ...
      doc.setFontSize(11);
      doc.text("RuangSinyal - QRIS Payment Receipt", centerX, 61, { align: "center" });
      doc.setFontSize(10);
      ...
      doc.setFont("helvetica", "normal");
      doc.text("Dokumen ini dibuat otomatis oleh sistem RuangSinyal dan valid sebagai bukti pembayaran.", 56, finalY + 58);
