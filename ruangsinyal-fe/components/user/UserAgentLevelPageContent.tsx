...
const kilatLevels = [
  {
    code: "start",
    name: "RuangSinyal Start",
    short: "Start",
    image: "/agent-levels/ruangsinyal-start-badge.png",
    ...
    benefits: [
      ["Limit sampai Rp 500.000", "Agent baru mulai dari limit dasar RuangSinyal", WalletCards],
      ["3 pengajuan lunas untuk naik", "Setelah 3 pinjaman lunas tepat waktu, agent naik ke RuangSinyal Plus", CheckCircle2],
  ...
  {
    code: "plus",
    name: "RuangSinyal Plus",
    short: "Plus",
    image: "/agent-levels/ruangsinyal-plus-badge.png",
    ...
    benefits: [
      ...
      ["5 pengajuan lunas untuk maksimal", "Setelah total 5 pinjaman lunas tepat waktu, agent naik ke RuangSinyal Elite", CheckCircle2],
  ...
  {
    code: "elite",
    name: "RuangSinyal Elite",
    short: "Elite",
    image: "/agent-levels/ruangsinyal-elite-badge.png",
    bg: "from-purple-50 via-white to-cyan-100",
    accent: "bg-purple-600",
    text: "text-purple-700",
    desc: "Level tertinggi RuangSinyal setelah agent menyelesaikan 5 pengajuan tepat waktu. Limit maksimal Rp 2.000.000.",
    benefits: [
      ...
      <section className={`relative min-h-[520px] overflow-hidden bg-linear-to-br ${activeLevel.bg} px-4 pt-5 text-slate-700`}>
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="truncate text-lg font-semibold text-slate-700">RuangSinyal Level</h1>
          </div>
        </div>
      ...
      <div className="-mt-24 px-3">
        <section className="relative z-20 overflow-hidden rounded-[28px] bg-white shadow-[0_22px_46px_rgba(15,23,42,0.14)]">
          <div className="border-b border-slate-100 px-5 py-5 text-center">
            ...
            <h2 className="text-2xl font-semibold text-slate-700">{activeLevel.name.replace("RuangSinyal ", "")}</h2>
