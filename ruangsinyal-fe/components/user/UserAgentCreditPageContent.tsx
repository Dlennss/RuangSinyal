...
const levelBadgeByCode: Record<string, string> = {
  start: "/agent-levels/ruangsinyal-start-badge.png",
  plus: "/agent-levels/ruangsinyal-plus-badge.png",
  pro: "/agent-levels/ruangsinyal-plus-badge.png",
  max: "/agent-levels/ruangsinyal-elite-badge.png",
  elite: "/agent-levels/ruangsinyal-elite-badge.png",
};
...
export function UserAgentCreditPageContent({ name, email, phone, storeName = "", mainBalance = 0, initialApplications = [] }: UserAgentCreditPageContentProps) {
  ...
  const creditLevelName = latestApplication?.credit_level_name || "RuangSinyal Start";
  ...
  const statusBandSubcopy = statusIsRejected
    ...
    : statusIsWaiting
      ? "Menunggu keputusan tim RuangSinyal"
      : statusIsPaid
      ...
      const response = await fetch("/api/agent-credit/applications", {
        ...
        body: JSON.stringify({
          ...
          applicant_data: {
            ...
            terms_version: "ruangsinyal-agent-credit-2026-07",
          },
      ...
      <section className="relative px-4 pb-3 pt-4 text-slate-950">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative min-w-0 flex-1">
            <p className="text-[10px] font-black uppercase tracking-[0.18em] text-[#168AF2]">RuangSinyal Agent</p>
      ...
      <div className="space-y-4 px-3">
        <section className="overflow-hidden rounded-[28px] border border-sky-950/[0.06] bg-white shadow-[0_20px_48px_rgba(22,138,242,0.10)]">
          <div className="relative p-4">
            ...
            <div className="min-w-0 flex-1">
              <p className="truncate text-base font-black text-slate-950">{name || "Agent RuangSinyal"}</p>
            ...
            <div className="mt-4 space-y-3">
              {listApplications.length ? (
                listApplications.map((item, index) => {
                  ...
                  const agentName = String(data.agent_name || data.nama_lengkap || `Agent RuangSinyal ${index + 1}`);
        ...
        <section className="rounded-[26px] border border-sky-950/5 bg-white p-4 shadow-[0_18px_42px_rgba(22,138,242,0.10)]">
          ...
          <ol className="space-y-2 text-[11px] font-semibold leading-5 text-slate-600">
            <li>1. Pinjaman saldo hanya digunakan untuk kebutuhan transaksi operasional di RuangSinyal.</li>
            ...
            <li>6. RuangSinyal berhak menolak, menunda, atau mengevaluasi ulang pengajuan jika data/bukti tidak sesuai.</li>
          </ol>
          <label className="mt-4 flex cursor-pointer items-start gap-3 rounded-2xl border border-sky-200 bg-sky-50/70 p-3">
            ...
            <span className="text-[11px] font-black leading-4 text-slate-950">Saya sudah membaca, memahami, dan menyetujui syarat & ketentuan kredit saldo RuangSinyal.</span>
          </label>
        </section>
        ...
        <p className="pb-2 text-center text-[10px] font-semibold text-[#168AF2]">Dokumen hanya digunakan untuk verifikasi pengajuan agent RuangSinyal.</p>
          </>
        )}
      </div>
