...
function getAgentName(item: AgentCreditApplication) {
  ...
  return item.agent_name || (typeof applicantName === "string" && applicantName.trim() ? applicantName : "") || item.agent_email || "Agent RuangSinyal";
}
              ...
              <div className="rounded-3xl border border-white/20 bg-white/12 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.25)] backdrop-blur">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-black">{view === "decision" ? "Final Kredit" : "RuangSinyal"}</p>
                  </div>
                </div>
              </div>
            </div>
