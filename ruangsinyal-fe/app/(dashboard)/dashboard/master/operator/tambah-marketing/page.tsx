...
export default function OperatorTambahMarketingPage() {
  ...
  return (
    <main className="min-h-screen bg-[#EFFBFF] p-3 text-slate-950 sm:p-6 lg:p-8">
      ...
      <RegisterMemberModal open={createOpen} onClose={() => setCreateOpen(false)} fixedRole="marketing" title="Tambah Marketing" subtitle="Buat akun marketing RuangSinyal untuk memantau agent binaan." theme="retail" createEndpoint="/api/operator/marketing/create" onSuccess={loadAccounts} />
