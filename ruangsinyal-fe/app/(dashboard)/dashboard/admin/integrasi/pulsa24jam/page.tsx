...
function appBaseURL() {
  return (
    ...
    process.env.APP_URL ||
    "https://domain-ruangsinyal-kamu.com"
  ).replace(/\/$/, "");
}
...
const commandRows = [
  ...
  },
  {
    ...
    catatan: "Refid wajib unik dari sistem RuangSinyal.",
  },
  {
    command: "INQ",
  ...
  const steps = [
    {
      ...
      desc: "Daftarkan IP publik server RuangSinyal di Pulsa24Jam. Tanpa ini, transaksi H2H akan ditolak.",
      icon: ShieldCheck,
    },
    {
      title: "2. Webhook Callback",
      desc: "Pasang URL callback RuangSinyal agar status pending, sukses, gagal, SN, dan keterangan final masuk otomatis.",
      icon: Webhook,
    },
    {
      title: "3. API Key",
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <h2 className="mt-1 text-xl font-black text-slate-950">Jalur hit RuangSinyal ke Pulsa24Jam</h2>
                  <p className="mt-2 text-sm font-semibold leading-6 text-slate-500">
                    Frontend dan panel hanya membuat order atau monitoring. Backend RuangSinyal yang menyimpan API key, mengirim command, mencatat refid, lalu menerima callback final.
                  </p>
                </div>
              </div>
