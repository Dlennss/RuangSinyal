...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Tagihan PGN | RuangSinyal",
      description: "Cek dan bayar tagihan gas PGN di RuangSinyal.",
      path: "/pgn",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | Tagihan PGN RuangSinyal`,
    description: `Cek dan bayar tagihan ${brand.nama} di RuangSinyal dengan proses yang ringkas.`,
    path: `/pgn/${slug}`,
    keywords: [`tagihan ${brand.nama.toLowerCase()}`, `bayar ${brand.nama.toLowerCase()}`, "pgn online", "ruangsinyal"],
  });
}
