...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      ...
      description: "Perpanjang masa aktif nomor Anda di RuangSinyal.",
      path: "/masa-aktif",
    });
  }
  ...
  return buildPageMetadata({
    title: `Perpanjang Masa Aktif ${brandTitle} | RuangSinyal`,
    description: lowestPrice
      ? `Perpanjang masa aktif ${brandTitle} di RuangSinyal. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Perpanjang masa aktif ${brandTitle} di RuangSinyal dengan pilihan produk yang jelas.`,
    path: `/masa-aktif/${slug}`,
    keywords: [`masa aktif ${brand.nama.toLowerCase()}`, `perpanjang masa aktif ${brand.nama.toLowerCase()}`, "ruangsinyal"],
...
export default async function MasaAktifBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Perpanjang Masa Aktif ${brandTitle} | RuangSinyal`,
    description: `Perpanjang masa aktif ${brandTitle} di RuangSinyal dengan pilihan produk yang jelas.`,
    path: `/masa-aktif/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah masa aktif ${brandTitle} di RuangSinyal tersedia dalam beberapa pilihan?`,
      answer: `Ya. RuangSinyal menampilkan produk masa aktif ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara memperpanjang masa aktif ${brandTitle} di RuangSinyal?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini bisa dipakai pembeli umum maupun member RuangSinyal untuk kebutuhan pribadi dan penjualan ulang.`,
    },
  ]);
