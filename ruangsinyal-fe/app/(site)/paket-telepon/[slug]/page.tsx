...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!phoneCategory) {
    return buildPageMetadata({
      title: "Paket Telepon Semua Operator | RuangSinyal",
      description: "Pilih paket telepon operator di RuangSinyal.",
      path: "/paket-telepon",
    });
  }
  ...
  return buildPageMetadata({
    title: `Paket Telepon ${brandTitle} | RuangSinyal`,
    description: lowestPrice
      ? `Pilih paket telepon ${brandTitle} di RuangSinyal. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Pilih paket telepon ${brandTitle} di RuangSinyal dengan pilihan produk yang jelas.`,
    path: `/paket-telepon/${slug}`,
    keywords: [`paket telepon ${brand.nama.toLowerCase()}`, `nelpon ${brand.nama.toLowerCase()}`, "ruangsinyal"],
...
export default async function GuestPaketTeleponBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Paket Telepon ${brandTitle} | RuangSinyal`,
    description: `Pilih paket telepon ${brandTitle} di RuangSinyal dengan pilihan produk yang jelas.`,
    path: `/paket-telepon/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah paket telepon ${brandTitle} di RuangSinyal tersedia dalam banyak pilihan?`,
      answer: `Ya. RuangSinyal menampilkan paket telepon ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara membeli paket telepon ${brandTitle} di RuangSinyal?`,
