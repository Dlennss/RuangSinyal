...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Aktivasi Perdana | RuangSinyal",
      description: "Pilih produk aktivasi perdana operator di RuangSinyal.",
  ...
  return buildPageMetadata({
    title: `Aktivasi Perdana ${brandTitle} | RuangSinyal`,
    description: lowestPrice
      ? `Pilih produk aktivasi perdana ${brandTitle} di RuangSinyal. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Pilih produk aktivasi perdana ${brandTitle} di RuangSinyal dengan pilihan yang jelas.`,
    path: `/aktivasi-perdana/${slug}`,
    keywords: [`aktivasi perdana ${brand.nama.toLowerCase()}`, `${brand.nama.toLowerCase()} perdana`, "ruangsinyal"],
...
export default async function AktivasiPerdanaBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Aktivasi Perdana ${brandTitle} | RuangSinyal`,
    description: `Pilih produk aktivasi perdana ${brandTitle} di RuangSinyal dengan pilihan yang jelas.`,
    path: `/aktivasi-perdana/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah produk aktivasi perdana ${brandTitle} di RuangSinyal tersedia lengkap?`,
      answer: `Ya. RuangSinyal menampilkan produk aktivasi perdana ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara membeli aktivasi perdana ${brandTitle} di RuangSinyal?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini dapat dipakai pembeli umum maupun member RuangSinyal untuk transaksi pribadi dan penjualan ulang.`,
    },
  ]);
