...
export const metadata: Metadata = buildPageMetadata({
  title: "Pulsa dan Paket Data | RuangSinyal",
  description: "Jelajahi pulsa dan paket data semua operator di RuangSinyal dalam satu halaman yang ringkas.",
  path: "/pulsa-data",
  keywords: ["pulsa dan paket data", "pulsa online", "paket data operator", "ruangsinyal"],
});
