...
export const metadata: Metadata = buildPageMetadata({
  title: "Tagihan Listrik PLN | RuangSinyal",
  description: "Bayar tagihan listrik PLN di RuangSinyal dengan alur yang ringkas untuk pelanggan rumah tangga dan agen.",
  path: "/listrik/tagihan",
  keywords: ["tagihan listrik", "bayar listrik", "pln pascabayar", "ruangsinyal listrik"],
});
