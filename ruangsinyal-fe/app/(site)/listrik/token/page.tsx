...
export const metadata: Metadata = buildPageMetadata({
  title: "Token Listrik PLN | RuangSinyal",
  description: "Beli token listrik PLN di RuangSinyal dengan pilihan nominal dan grup produk yang lebih jelas.",
  path: "/listrik/token",
  keywords: ["token listrik", "token pln", "beli token listrik", "ruangsinyal listrik"],
