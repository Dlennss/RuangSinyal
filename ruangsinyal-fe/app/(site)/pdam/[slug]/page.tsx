...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Tagihan PDAM | RuangSinyal",
      description: "Cek dan bayar tagihan PDAM di RuangSinyal.",
      path: "/pdam",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | Tagihan PDAM RuangSinyal`,
    description: `Cek dan bayar tagihan ${brand.nama} di RuangSinyal dengan proses cepat dan ringkas.`,
    path: `/pdam/${slug}`,
    keywords: [`tagihan ${brand.nama.toLowerCase()}`, `bayar ${brand.nama.toLowerCase()}`, "pdam online", "ruangsinyal"],
  });
}
