...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Cek dan bayar tagihan PDAM berbagai daerah di RuangSinyal dengan langkah yang ringkas dan pilihan wilayah yang jelas.",
  path: "/pdam",
  keywords: ["bayar pdam online", "tagihan pdam", "cek tagihan air", "pdam ruangsinyal"],
});
