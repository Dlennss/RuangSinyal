...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!article) {
    return {
      title: "Artikel Tidak Ditemukan | RuangSinyal",
    };
  }

  return {
    metadataBase: new URL(CANONICAL_SITE_URL),
    title: `${article.title} | RuangSinyal`,
...
export default async function ArtikelDetailPage({ params }: Props) {
  ...
  const ctaDescription =
    article.category === "Bisnis Agen"
      ? "Setelah memahami arahnya, lanjutkan ke halaman RuangSinyal yang paling membantu pertumbuhan usaha dan layanan member Anda."
      : article.category === "Panduan Member"
        ...
        : article.category === "H2H"
          ...
          : article.category === "Deposit"
            ...
            : "Jika Anda sudah memahami produknya, lanjutkan ke halaman layanan RuangSinyal yang paling relevan untuk kebutuhan Anda.";
