...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (universalService) {
    return buildPageMetadata({
      title: `${universalService === "esim-roaming" ? "eSIM & Roaming" : "HP Pascabayar"} | RuangSinyal`,
      description: "Layanan digital RuangSinyal.",
      path: `/kategori/${id}`,
    });
  }
  ...
  if (!category) {
    return buildPageMetadata({
      title: "Kategori Produk | RuangSinyal",
      description: "Lihat kategori produk RuangSinyal.",
      path: "/kategori",
    });
  }

  return buildPageMetadata({
    title: `${category.nama} | RuangSinyal`,
    description: `Lihat pilihan brand dan produk ${category.nama} di RuangSinyal.`,
    path: `/kategori/${id}`,
    keywords: [String(category.nama).toLowerCase(), "produk ruangsinyal", "ruangsinyal"],
  });
}
...
export default async function GuestKategoriPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${categoryName} | RuangSinyal`,
    description: `Lihat pilihan brand dan produk ${categoryName} di RuangSinyal.`,
    path: `/kategori/${id}`,
