...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Top Up E-Wallet | RuangSinyal",
      description: "Top up e-wallet favorit Anda di RuangSinyal.",
      path: "/ewallet",
    });
  }
  ...
  return buildPageMetadata({
    title: `Top Up ${brandTitle} Online | RuangSinyal`,
    description: lowestPrice
      ? `Top up ${brandTitle} online di RuangSinyal dengan nominal tetap dan bebas nominal. Harga mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Top up ${brandTitle} di RuangSinyal dengan pilihan nominal tetap dan bebas nominal yang lebih jelas.`,
    path: `/ewallet/${slug}`,
    keywords: [`top up ${brand.nama.toLowerCase()}`, `${brand.nama.toLowerCase()} ruangsinyal`, "ewallet"],
...
export default async function EwalletBrandPage({ params, searchParams }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Top Up ${brandTitle} Online | RuangSinyal`,
    description: `Top up ${brandTitle} di RuangSinyal dengan pilihan nominal tetap dan bebas nominal yang lebih jelas.`,
    path: `/ewallet/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah top up ${brandTitle} di RuangSinyal bisa pilih nominal tetap dan bebas nominal?`,
      answer: `Ya. RuangSinyal menampilkan produk ${brandTitle} yang aktif, termasuk nominal tetap dan varian bebas nominal bila tersedia.`,
    },
    {
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini dipakai untuk kebutuhan top up pribadi maupun penjualan ulang oleh member RuangSinyal.`,
    },
  ]);
