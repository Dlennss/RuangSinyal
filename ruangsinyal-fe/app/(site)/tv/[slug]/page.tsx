...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "TV Berlangganan | RuangSinyal",
      description: "Beli paket atau bayar layanan TV berlangganan di RuangSinyal.",
      path: "/tv",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | TV Berlangganan RuangSinyal`,
    description: `Beli paket atau bayar layanan ${brand.nama} di RuangSinyal dengan proses yang ringkas.`,
    path: `/tv/${slug}`,
    keywords: [`${brand.nama.toLowerCase()}`, `bayar ${brand.nama.toLowerCase()}`, "tv berlangganan", "ruangsinyal"],
