...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Internet Pascabayar | RuangSinyal",
      description: "Cek dan bayar tagihan internet pascabayar di RuangSinyal.",
      path: "/internet-pascabayar",
    });
  }

  return buildPageMetadata({
    title: `${toTitleCase(brand.nama)} | Internet Pascabayar RuangSinyal`,
    description: `Cek dan bayar tagihan ${toTitleCase(brand.nama)} di RuangSinyal dengan proses yang ringkas.`,
    path: `/internet-pascabayar/${slug}`,
    keywords: [`${String(brand.nama).toLowerCase()} pascabayar`, `bayar ${String(brand.nama).toLowerCase()}`, "internet pascabayar", "ruangsinyal"],
  });
}
...
export default async function InternetPascabayarSlugPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${brandTitle} | Internet Pascabayar RuangSinyal`,
    description: `Cek dan bayar tagihan ${brandTitle} di RuangSinyal dengan proses yang ringkas.`,
    path: `/internet-pascabayar/${slug}`,
