...
const pageTitle = "Privacy Policy RuangSinyal | Website and Android App";
const pageDescription =
  "Privacy policy for RuangSinyal website and Android application, including account data, transactions, security, and Google sign-in usage.";
