...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Top Up Game Online | RuangSinyal",
      description: "Top up game online favorit Anda di RuangSinyal.",
      path: "/game",
    });
  }
  ...
  return buildPageMetadata({
    title: `Top Up ${brandTitle} Murah | RuangSinyal`,
    description: lowestPrice
      ? `Top up ${brandTitle} di RuangSinyal dengan pilihan nominal aktif. Harga mulai Rp ${lowestPrice.toLocaleString("id-ID")} dan transaksi cepat.`
      : `Top up ${brandTitle} di RuangSinyal dengan pilihan nominal yang jelas dan proses transaksi cepat.`,
    path: `/game/${slug}`,
    keywords: [`top up ${brand.nama.toLowerCase()}`, `${brand.nama.toLowerCase()} murah`, "voucher game", "ruangsinyal"],
...
export default async function GameBrandPage({ params, searchParams }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Top Up ${brandTitle} Murah | RuangSinyal`,
    description: `Top up ${brandTitle} di RuangSinyal dengan pilihan nominal yang jelas dan proses transaksi cepat.`,
    path: `/game/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah top up ${brandTitle} di RuangSinyal tersedia dalam banyak pilihan nominal?`,
      answer: `Ya. RuangSinyal menampilkan produk ${brandTitle} yang aktif agar pembeli bisa memilih nominal yang sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara top up ${brandTitle} di RuangSinyal?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini bisa dipakai pembeli umum maupun member RuangSinyal untuk transaksi pribadi dan penjualan ulang.`,
    },
  ]);
