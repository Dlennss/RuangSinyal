...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (slug !== "kesehatan" && slug !== "ketenagakerjaan") {
    return buildPageMetadata({
      title: "BPJS | RuangSinyal",
      description: "Cek dan bayar BPJS di RuangSinyal.",
      path: "/bpjs",
    });
  }
  ...
  return buildPageMetadata({
    title: `${title} | RuangSinyal`,
    description: `Cek dan bayar ${title} di RuangSinyal dengan alur yang ringkas.`,
    path: `/bpjs/${slug}`,
    keywords: [title.toLowerCase(), "bayar bpjs", "ruangsinyal"],
  });
}
