# Dokumentasi Jaringan Retail RuangSinyal

README ini menjelaskan modul jaringan retail pada aplikasi RuangSinyal, mulai dari role, struktur downline, komisi, withdraw, endpoint, sampai tabel database yang dipakai.
...
- `ruangsinyal-fe/components/user/RetailDownlineManager.tsx`
- `ruangsinyal-fe/components/user/RetailCommissionClient.tsx`
- `ruangsinyal-fe/components/user/RetailWithdrawClient.tsx`
- `ruangsinyal-fe/components/dashboard/RetailWithdrawRequestsPage.tsx`
- `ruangsinyal-fe/lib/memberRoles.ts`
